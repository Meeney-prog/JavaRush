...
public class Solution {
    ...
    protected void updateLastDate(long delta) {
        ...
        Date newDate = new Date(lastDate.getTime()+delta);
        dates.add(newDate);
        lastDate = newDate;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(dates, solution.dates) &&
                Objects.equals(lastDate, solution.lastDate);
    }

    @Override
    public int hashCode() {
        return Objects.hash(dates, lastDate);
    }
}